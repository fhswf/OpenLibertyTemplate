<%@ page contentType="text/html; charset=UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            <jsp:useBean id="locales" scope="application" class="de.fhswf.fit.MyLocales" />

            <form name="localeForm" action="test.jsp" method="post">
            ...
            <c:if test="${selectedFlag}">
                ...
                <jsp:useBean id="date" class="de.fhswf.fit.MyDate" />
